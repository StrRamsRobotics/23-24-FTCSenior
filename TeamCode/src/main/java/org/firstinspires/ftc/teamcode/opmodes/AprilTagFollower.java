...
@Config
@Autonomous
@Disabled //bc don't wanan reafactor to visionporrtal
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (detections.size() > 0 && !following) {
                ...
                double x = pose.x* METRES_TO_INCH -camx;

                tel.addData("x in", x);
                tel.addData("y in", pose.y* METRES_TO_INCH);
                double z = pose.z* METRES_TO_INCH -camy;
                tel.addData("z in", z);
                tel.update();
